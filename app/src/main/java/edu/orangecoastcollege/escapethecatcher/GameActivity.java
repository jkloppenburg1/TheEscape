...
public class GameActivity extends Activity implements GestureDetector.OnGestureListener{
    ...
    private void createZombie() {
        ...
        int row = 5;
        int col = 5;
        // Instantiate new Zombie object
        zombie = new Zombie(row, col);
        ...
        // Add zombie image view to the Array List
    ...
    private void movePlayer(float velocityX, float velocityY) {
        ...
        String direction = "";
        if (Math.abs(velocityX) > Math.abs(velocityY)) // if moving horizontally
        {
